function [vecY,k,k2,M_o,M_u,Y_confinal,M_a, A,idn]=create_matrixVBtestwithRSTIQ3test(ind,Y_2,lag,m,RSTI,ITL1shares,Y_con)
RSTI = RSTI(182:end,:);
[n,T]=size(Y_2);
R = 12;
...
Ma_RSTI = [A1new(182:end-2,:);A2new(182:end-2,:);A3new(182:end-2,:);A4new(182:end-2,:);A5new(182:end-2,:);A6new(182:end-2,:);A7new(182:end-2,:);A8new(182:end-2,:);...
    A9new(182:end-2,:);A10new(182:end-2,:);A11new(182:end,:);A12new(182:end-1,:)];
Y_RSTI =[reshape(RSTI(1:end-2,1:10),size(RSTI(1:end-2,1:10),1)*10,1);RSTI(1:end,11);RSTI(1:end-1,12)];
